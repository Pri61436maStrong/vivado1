...
HD_PWD='E:/FPGA_workspace/luowei/release_fpga/wyl_finnal/0731/one_input_wk_display_custop0_24073104/AI_Mate_IP/ps_in.runs/w514d512_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log w514d512_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source w514d512_fifo.tcl
