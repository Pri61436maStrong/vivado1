...
#
# Generated by export_simulation on Fri Aug 30 18:37:16 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './base_axis_fifo_cdc64.sh' script.

./base_axis_fifo_cdc64.sh -reset_run
...
./base_axis_fifo_cdc64.sh -noclean_files

For more information on the script, please type './base_axis_fifo_cdc64.sh -help'.
