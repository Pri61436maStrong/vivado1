...
#
# Generated by export_simulation on Tue Mar 12 14:27:15 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './add_int64.sh' script.

./add_int64.sh -reset_run
...
./add_int64.sh -noclean_files

For more information on the script, please type './add_int64.sh -help'.
