...
#
# Generated by export_simulation on Tue Mar 12 14:30:24 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './add_int15.sh' script.

./add_int15.sh -reset_run
...
./add_int15.sh -noclean_files

For more information on the script, please type './add_int15.sh -help'.
