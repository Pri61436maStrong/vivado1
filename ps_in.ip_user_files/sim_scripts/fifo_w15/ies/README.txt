...
#
# Generated by export_simulation on Tue Mar 12 14:23:11 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_w15.sh' script.

./fifo_w15.sh -reset_run
...
./fifo_w15.sh -noclean_files

For more information on the script, please type './fifo_w15.sh -help'.
