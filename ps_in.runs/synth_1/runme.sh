...
HD_PWD='C:/Users/Smvar/Desktop/Project/reconfigure_test/ps_in.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nms_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nms_top.tcl
