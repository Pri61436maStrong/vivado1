...
HD_PWD='C:/Users/Smvar/Desktop/Project/reconfigure_test/ps_in.runs/img_data_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log img_data_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source img_data_rom.tcl
