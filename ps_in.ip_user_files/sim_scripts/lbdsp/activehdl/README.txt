...
#
# Generated by export_simulation on Tue May 28 15:36:16 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './lbdsp.sh' script.
...
./lbdsp.sh -noclean_files

For more information on the script, please type './lbdsp.sh -help'.
