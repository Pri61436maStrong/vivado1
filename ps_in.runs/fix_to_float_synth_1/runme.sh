...
HD_PWD='E:/FPGA_workspace/luowei/release_fpga/wyl_finnal/0731/one_input_wk_display_custop0_24073104/AI_Mate_IP/ps_in.runs/fix_to_float_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fix_to_float.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fix_to_float.tcl
