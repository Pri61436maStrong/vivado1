...
#
# Generated by export_simulation on Tue Mar 12 14:24:57 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_w512.sh' script.

./fifo_w512.sh -reset_run
...
./fifo_w512.sh -noclean_files

For more information on the script, please type './fifo_w512.sh -help'.
