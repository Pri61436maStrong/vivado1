...
#
# Generated by export_simulation on Tue Mar 12 14:33:28 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_w25.sh' script.

./fifo_w25.sh -reset_run
...
./fifo_w25.sh -noclean_files

For more information on the script, please type './fifo_w25.sh -help'.
