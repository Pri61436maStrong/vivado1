...
#
# Generated by export_simulation on Thu Jan 04 09:55:55 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './add_32_32.sh' script.

./add_32_32.sh -reset_run
...
./add_32_32.sh -noclean_files

For more information on the script, please type './add_32_32.sh -help'.
