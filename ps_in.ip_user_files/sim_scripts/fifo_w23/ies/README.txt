...
#
# Generated by export_simulation on Tue Mar 12 14:29:48 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_w23.sh' script.

./fifo_w23.sh -reset_run
...
./fifo_w23.sh -noclean_files

For more information on the script, please type './fifo_w23.sh -help'.
