...
#
# Generated by export_simulation on Tue May 28 15:37:22 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './bdsp.sh' script.
...
./bdsp.sh -noclean_files

For more information on the script, please type './bdsp.sh -help'.
