...
HD_PWD='E:/FPGA_workspace/wangyl/prj_2024/0830/one_input_wk_display_custop0_24073104/AI_Mate_IP/ps_in.runs/base_axis_fifo_cdc64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axis_fifo_cdc64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axis_fifo_cdc64.tcl
